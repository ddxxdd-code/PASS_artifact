# Run setup of remote SPDK NVMe-oF target
...
echo "Running remote setup on ${REMOTE_USER}@${REMOTE_IP}: sudo ${REMOTE_SCRIPT} setup_spdk"

# Use a specific SSH_KEY
SSH_KEY="/home/dedongx/.ssh/id_ed25519"
ssh -i "$SSH_KEY" "${REMOTE_USER}@${REMOTE_IP}" "sudo ${REMOTE_SCRIPT} setup_spdk"
